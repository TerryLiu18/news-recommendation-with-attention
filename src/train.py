...
def train():
    ...
    dataset = BaseDataset('data/train/behaviors_parsed.tsv', 'data/train/news_parsed.tsv')
    ...
    checkpoint_dir = path.join('./checkpoint', 'NRMS')
    ...
    print('total step', config.num_epochs * len(dataset) // config.batch_size + 1)
